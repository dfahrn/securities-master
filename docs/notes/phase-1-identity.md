...
This note explains the design of `core.security` / `core.security_identifier`.
It assumes the reader knows SQL and basic Postgres, but has not read the code.
Each section answers one question a reviewer could reasonably push back on.
